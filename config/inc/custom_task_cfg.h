...
// TASK_ITEM(Debug_task,  subtask1_id, Debug_Task_Size, DEFAULT_VALUE1, DEFAULT_VALUE2)
// TASK_ITEM(GPS_task,  subtask2_id, GPS_TASK_Stak, DEFAULT_VALUE1, DEFAULT_VALUE2)
// TASK_ITEM(GSM_task,  subtask3_id, GSM_TASK_Stak, DEFAULT_VALUE1, DEFAULT_VALUE2)
// TASK_ITEM(AVL_task,  subtask4_id, DB_EVENT_TASK_Stak, DEFAULT_VALUE1, DEFAULT_VALUE2)
// TASK_ITEM(IO_task,  subtask5_id, IO_TASK_Stak, DEFAULT_VALUE1, DEFAULT_VALUE2)
// TASK_ITEM(BT_task,  subtask6_id, BT_TASK_Stak, DEFAULT_VALUE1, DEFAULT_VALUE2)
